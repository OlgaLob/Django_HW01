...
def index(request):
    ...
    <body>
        ...
        <h2>Обо мне</h2>
        <p>Привет, меня зовут Ольга Лобанова. Я являюсь начинающим веб-разработчиком и увлекаюсь созданием интерактивных и красивых веб-сайтов. Мои навыки включают Python и Django.</p>

        <footer>
            <p>Свяжитесь со мной: lobolg975@gmail.com | +79851744456</p>
        </footer>
    </body>
    </html>
    """
